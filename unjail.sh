...
echo "Thanks to major contributions from thebeastgamer25"
...
echo "CYDIA IS ABOUT TO CRASH. PLEASE GO TO SETTINGS IMMEDIATLEY AND USE ERASE ALL CONTENTS AND SETTINGS! THIS PACKAGE ONLY DOES HALF OF THE WORK NEEDED. PLEASE DO THIS!"
sleep 10
